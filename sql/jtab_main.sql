...
--
-- Host: localhost
-- Czas wygenerowania: 27 Sie 2013, 22:22
...
CREATE TABLE IF NOT EXISTS `jtab.main` (
  ...
  UNIQUE KEY `Main.Part Number` (`Main.Part Number`),
...
('HP', 'Touch Pad FB356', 'FB356UA#ABA', '', '190 X 240 X 13.7mm', '740', 'WebOS 3.0', '6300mAh', '8h', 'Micro SD (upto 32 GB)', '16 GB / 32 GB', 'Dual Core 1700 Mhz QUALCOMM Snapdragon APQ8060', '1 GB', 'No', '1024 X 768', '9.7 inch', 'TFT', 'Yes', 'Yes', '', 'Yes', 'Yes', 'Yes', 'None', '1.3 MP', '720 p', 'GSM 850, 900, 1800, 1900\nWCDMA 850, 1900', 'HSPA+ (4G), HSUPA (3.5G), HSDPA (3.5G), WCDMA (3G)', '2,1', 'a/b/g/n', 'USB 2.0', 'None', 'Available', 'Black;White', '2011-07-01', 'Europe', '300'),
('HP', 'Touch Pad FB401', 'FB401UA#ABA', '', '190 X 240 X 13.7mm', '740', 'WebOS 3.0', '6300mAh', '8h', 'Micro SD (upto 32 GB)', '16 GB / 32 GB', 'Dual Core 1700 Mhz QUALCOMM Snapdragon APQ8060', '1 GB', 'No', '1024 X 768', '9.7 inch', 'TFT', 'Yes', 'Yes', '', 'Yes', 'Yes', 'Yes', 'None', '1.3 MP', '720 p', 'GSM 850, 900, 1800, 1900\nWCDMA 850, 1900', 'HSPA+ (4G), HSUPA (3.5G), HSDPA (3.5G), WCDMA (3G)', '2,1', 'a/b/g/n', 'USB 2.0', 'None', 'Available', 'Black;White', '2011-07-01', 'Europe', '300'),
